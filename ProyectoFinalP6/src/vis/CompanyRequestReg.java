				...
				btnReg.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(JobCenter.getInstance().findCompanyById(txtId.getText()) != null) {
							...
							JOptionPane.showMessageDialog(null, "El registro fue completado con �xito.", "Aviso", JOptionPane.INFORMATION_MESSAGE);
							dispose();
						}
						else {
							JOptionPane.showMessageDialog(null, "No se pudo crear la solicitud. C�dula incorrecta o inexistente.", "Error", JOptionPane.ERROR_MESSAGE);
						}
					}
				});
