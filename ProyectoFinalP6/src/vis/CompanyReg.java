...
public class CompanyReg extends JDialog {
	...
	public static void main(String[] args) {
		try {
			CompanyReg dialog = new CompanyReg();
	...
	public CompanyReg() {
		...
		JComboBox<String> cbxProvince = new JComboBox<String>();
		...
		textField.setBounds(165, 344, 311, 28);
		panel.add(textField);
		...
		textField_1.setBounds(165, 394, 145, 28);
